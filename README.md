...
### Get or update `utia-gc/scrnaseq`

1. Download or update `utia-gc/scrnaseq`:
...
### Test `utia-gc/scrnaseq`

1. Check that `utia-gc/scrnaseq` works on your system:

   - `-profile nf_test` uses preconfigured test parameters to run `utia-gc/scrnaseq` in full on a small test dataset stored in a remote GitHub repository.
